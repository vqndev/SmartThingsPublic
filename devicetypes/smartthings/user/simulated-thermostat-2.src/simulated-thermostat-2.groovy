...
preferences {
    input("serverIP", "text", title: "Server IP Address")
}
...
metadata {
    ...
    definition (name: "Simulated Thermostat 2", namespace: "smartthings/user", author: "SmartThings") {
        capability "Sensor"
        capability "Actuator"
    ...
    tiles(scale: 2) {
        ...
        standardTile("refresh", "device", inactiveLabel: false, height: 2, width: 2, decoration: "flat") {
...
private initialize() {
    ...
    // for HealthCheck
    sendEvent(name: "checkInterval", value: 60, displayed: true, data: [protocol: "cloud", scheme: "untracked"])
...
void calledBackHandler(physicalgraph.device.HubResponse hubResponse) {
    ...
    log.debug "body $body"
    sendEvent(name: "humidity", value: body.humidity, unit: "%")
    sendEvent(name: "temperature", value: body.temperature, unit: "°F")
